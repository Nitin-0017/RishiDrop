...
export const GuardLayout: React.FC = () => {
  ...
  return (
    <div
      className="h-screen h-[100dvh] bg-[#F8FAFC] flex relative w-full min-w-0 overflow-hidden antialiased text-[#172033]"
      style={{
      ...
      <div className="flex-1 min-w-0 h-full flex flex-col overflow-y-auto overflow-x-hidden transition-all duration-[380ms] ease-in-out">
        ...
        <div className="md:hidden flex items-center justify-between h-14 px-4 bg-white border-b border-[#E6E8EC] sticky top-0 z-30 shadow-xs shrink-0">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-[9px] uppercase font-bold px-1.5 py-0.5 rounded bg-[#F0FDF4] text-[#16865B] border border-[#DCFCE7]">
              GUARD
            </span>
          </div>
        ...
        {/* Main Content Area: Reclaims space from horizontal top bar, matching Admin Portal spacing */}
        <main className="flex-1 min-w-0 flex flex-col">
          <div className="flex-1 px-4 sm:px-6 lg:px-8 py-6 w-full max-w-[1500px] mx-auto min-w-0">
            <Outlet />
          </div>
        </main>
      </div>
